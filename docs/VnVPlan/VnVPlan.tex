...
\begin{longtable}{c c c c c c c c c c}
\caption{Initial Flocking Parameters} \label{TblMotionTest1} \\
\hline
...
\begin{longtable}{c c c c c c c c c c}
\caption{Initial Flocking Parameters} \label{TblMotionTest2} \\
\hline
$N$ & ${\Delta t}\text{(s)}$ & $k_a$ & $k_c$ & $k_s$ & $k_o$ & $k_g$ & $\mathbf{p}_1\text{(m,m)}$ & $\mathbf{r}_1\text{(m)}$ & $\mathbf{M}$ \\
\hline
...
\begin{longtable}{c c c c c c c c c c}
\caption{Initial Flocking Parameters} \label{TblBoundTest1} \\
\hline
$N$ & ${\Delta t}\text{(s)}$ & $k_a$ & $k_c$ & $k_s$ & $k_o$ & $k_g$ & $\mathbf{p}_1\text{(m,m)}$ & $\mathbf{r}_1\text{(m)}$ & $\mathbf{M}$ \\
\hline
...
\begin{longtable}{c c c c c c c c c c}
\caption{Initial Flocking Parameters} \label{TblMethodTest1} \\
\hline
$N$ & ${\Delta t}\text{(s)}$ & $k_a$ & $k_c$ & $k_s$ & $k_o$ & $k_g$ & $\mathbf{p}_1\text{(m,m)}$ & $\mathbf{r}_1\text{(m)}$ & $\mathbf{M}$ \\
\hline
